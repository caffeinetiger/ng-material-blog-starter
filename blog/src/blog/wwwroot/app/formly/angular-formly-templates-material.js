...
(function (FormlyMaterial) {
    ...
    angular.module('formlyMaterial', ['formly'])
        ...
        angular.forEach(['checkbox', 'radio', 'radioRow', 'radioRowTall'], function (fieldName) {
            formlyConfig.setType({
                name: fieldName,
                templateUrl: getFieldTemplateUrl(fieldName)
            });
        });
        angular.forEach(['input', 'textarea', 'iDsbdPrice', 'iQty', 'iInt', 'rPrice', 'iPhone'], function (fieldName) {
            formlyConfig.setType({
                name: fieldName,
                templateUrl: getFieldTemplateUrl(fieldName),
                defaultOptions: {
                    templateOptions: {
                        hintNeeded: true,
                        onFocus: function (value, options) {
                            options.validation.show = false;
                        },
                        onBlur: function (value, options, scope) {
        ...
        function getTemplateUrl(type, name) {
        ...
        '$templateCache', function ($templateCache) {
            ...
            $templateCache.put('fields/mtrl-radio.html', "<md-radio-group ng-model=\"model[options.key]\">" +
            ...
            $templateCache.put('fields/mtrl-rPrice.html', "<md-radio-group ng-model=\"model[options.key]\"" +
                "> <md-radio-button " +
            ...
            $templateCache.put('wrapper/mtrl-mdIQtyContainer.html', '<div layout>' +
...
//# sourceMappingURL=angular-formly-templates-material.js.map